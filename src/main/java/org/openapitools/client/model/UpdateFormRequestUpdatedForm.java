...
public class UpdateFormRequestUpdatedForm {
  ...
  public UpdateFormRequestUpdatedForm name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateFormRequestUpdatedForm dataType(@javax.annotation.Nullable CreateFormRequestFormToCreateDataType dataType) {
  ...
  public UpdateFormRequestUpdatedForm formActionType(@javax.annotation.Nullable FormActionType formActionType) {
  ...
  public UpdateFormRequestUpdatedForm fields(@javax.annotation.Nullable Map fields) {
    this.fields = fields;
    return this;
  }
  ...
  public UpdateFormRequestUpdatedForm style(@javax.annotation.Nullable CreateFormRequestFormToCreateStyle style) {
    this.style = style;
    return this;
  }
  ...
  public UpdateFormRequestUpdatedForm sectionalElements(@javax.annotation.Nullable Map sectionalElements) {
  ...
  public UpdateFormRequestUpdatedForm schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public UpdateFormRequestUpdatedForm cta(@javax.annotation.Nullable CreateFormRequestFormToCreateCta cta) {
    this.cta = cta;
    return this;
  }
  ...
  public UpdateFormRequestUpdatedForm labelDecorator(@javax.annotation.Nullable LabelDecorator labelDecorator) {
