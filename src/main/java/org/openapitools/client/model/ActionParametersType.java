...
public class ActionParametersType {
  ...
  public ActionParametersType() {
  }

  public ActionParametersType value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersType bindingProperties(@javax.annotation.Nullable ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersType collectionBindingProperties(@javax.annotation.Nullable ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersType defaultValue(@javax.annotation.Nullable String defaultValue) {
  ...
  public ActionParametersType model(@javax.annotation.Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersType bindings(@javax.annotation.Nullable Map bindings) {
  ...
  public ActionParametersType event(@javax.annotation.Nullable String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersType userAttribute(@javax.annotation.Nullable String userAttribute) {
  ...
  public ActionParametersType concat(@javax.annotation.Nullable List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersType condition(@javax.annotation.Nullable ComponentPropertyCondition condition) {
  ...
  public ActionParametersType configured(@javax.annotation.Nullable Boolean configured) {
  ...
  public ActionParametersType type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersType importedValue(@javax.annotation.Nullable String importedValue) {
  ...
  public ActionParametersType componentName(@javax.annotation.Nullable String componentName) {
  ...
  public ActionParametersType property(@javax.annotation.Nullable String property) {
  ...
  public boolean equals(Object o) {
    ...
    ActionParametersType actionParametersType = (ActionParametersType) o;
    return Objects.equals(this.value, actionParametersType.value) &&
        Objects.equals(this.bindingProperties, actionParametersType.bindingProperties) &&
        Objects.equals(this.collectionBindingProperties, actionParametersType.collectionBindingProperties) &&
        Objects.equals(this.defaultValue, actionParametersType.defaultValue) &&
        Objects.equals(this.model, actionParametersType.model) &&
        Objects.equals(this.bindings, actionParametersType.bindings) &&
        Objects.equals(this.event, actionParametersType.event) &&
        Objects.equals(this.userAttribute, actionParametersType.userAttribute) &&
        Objects.equals(this.concat, actionParametersType.concat) &&
        Objects.equals(this.condition, actionParametersType.condition) &&
        Objects.equals(this.configured, actionParametersType.configured) &&
        Objects.equals(this.type, actionParametersType.type) &&
        Objects.equals(this.importedValue, actionParametersType.importedValue) &&
        Objects.equals(this.componentName, actionParametersType.componentName) &&
        Objects.equals(this.property, actionParametersType.property);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionParametersType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionParametersType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionParametersType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionParametersType is not found in the empty JSON string", ActionParametersType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionParametersType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionParametersType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionParametersType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionParametersType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionParametersType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionParametersType.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionParametersType>() {
           @Override
           public void write(JsonWriter out, ActionParametersType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionParametersType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionParametersType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionParametersType
   * @throws IOException if the JSON string is invalid with respect to ActionParametersType
   */
  public static ActionParametersType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionParametersType.class);
  }

  /**
   * Convert an instance of ActionParametersType to an JSON string
   *
   * @return JSON string
   */
