...
public class ComponentConditionPropertyElse {
  ...
  public ComponentConditionPropertyElse value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public ComponentConditionPropertyElse bindingProperties(@javax.annotation.Nullable ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ComponentConditionPropertyElse collectionBindingProperties(@javax.annotation.Nullable ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ComponentConditionPropertyElse defaultValue(@javax.annotation.Nullable String defaultValue) {
  ...
  public ComponentConditionPropertyElse model(@javax.annotation.Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public ComponentConditionPropertyElse bindings(@javax.annotation.Nullable Map bindings) {
  ...
  public ComponentConditionPropertyElse event(@javax.annotation.Nullable String event) {
    this.event = event;
    return this;
  }
  ...
  public ComponentConditionPropertyElse userAttribute(@javax.annotation.Nullable String userAttribute) {
  ...
  public ComponentConditionPropertyElse concat(@javax.annotation.Nullable List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ComponentConditionPropertyElse condition(@javax.annotation.Nullable ComponentPropertyCondition condition) {
  ...
  public ComponentConditionPropertyElse configured(@javax.annotation.Nullable Boolean configured) {
  ...
  public ComponentConditionPropertyElse type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ComponentConditionPropertyElse importedValue(@javax.annotation.Nullable String importedValue) {
  ...
  public ComponentConditionPropertyElse componentName(@javax.annotation.Nullable String componentName) {
  ...
  public ComponentConditionPropertyElse property(@javax.annotation.Nullable String property) {
