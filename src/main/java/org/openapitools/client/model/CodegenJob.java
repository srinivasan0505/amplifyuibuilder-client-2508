...
public class CodegenJob {
  ...
  public CodegenJob id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public CodegenJob appId(@javax.annotation.Nonnull String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public CodegenJob environmentName(@javax.annotation.Nonnull String environmentName) {
  ...
  public CodegenJob renderConfig(@javax.annotation.Nullable CodegenJobRenderConfig renderConfig) {
  ...
  public CodegenJob genericDataSchema(@javax.annotation.Nullable CodegenJobGenericDataSchema genericDataSchema) {
  ...
  public CodegenJob autoGenerateForms(@javax.annotation.Nullable Boolean autoGenerateForms) {
  ...
  public CodegenJob features(@javax.annotation.Nullable CodegenFeatureFlags features) {
  ...
  public CodegenJob status(@javax.annotation.Nullable CodegenJobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CodegenJob statusMessage(@javax.annotation.Nullable String statusMessage) {
  ...
  public CodegenJob asset(@javax.annotation.Nullable CodegenJobAsset asset) {
    this.asset = asset;
    return this;
  }
  ...
  public CodegenJob tags(@javax.annotation.Nullable Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CodegenJob createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public CodegenJob modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
