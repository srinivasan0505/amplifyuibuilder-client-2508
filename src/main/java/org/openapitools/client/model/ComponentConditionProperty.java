...
public class ComponentConditionProperty {
  ...
  public ComponentConditionProperty property(@javax.annotation.Nullable String property) {
  ...
  public ComponentConditionProperty field(@javax.annotation.Nullable String field) {
    this.field = field;
    return this;
  }
  ...
  public ComponentConditionProperty operator(@javax.annotation.Nullable String operator) {
  ...
  public ComponentConditionProperty operand(@javax.annotation.Nullable String operand) {
  ...
  public ComponentConditionProperty then(@javax.annotation.Nullable ComponentConditionPropertyThen then) {
    this.then = then;
    return this;
  }
  ...
  public ComponentConditionProperty _else(@javax.annotation.Nullable ComponentConditionPropertyElse _else) {
    this._else = _else;
    return this;
  }
  ...
  public ComponentConditionProperty operandType(@javax.annotation.Nullable String operandType) {
