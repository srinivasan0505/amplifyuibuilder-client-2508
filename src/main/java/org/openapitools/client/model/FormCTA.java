...
public class FormCta {
  ...
  public FormCta position(@javax.annotation.Nullable FormButtonsPosition position) {
  ...
  public FormCta clear(@javax.annotation.Nullable FormCTAClear clear) {
    this.clear = clear;
    return this;
  }
  ...
  public FormCta cancel(@javax.annotation.Nullable FormCTACancel cancel) {
    this.cancel = cancel;
    return this;
  }
  ...
  public FormCta submit(@javax.annotation.Nullable FormCTASubmit submit) {
    this.submit = submit;
    return this;
  }
