...
public class CodegenGenericDataRelationshipType {
  ...
  public CodegenGenericDataRelationshipType type(@javax.annotation.Nonnull GenericDataRelationshipType type) {
    this.type = type;
    return this;
  }
  ...
  public CodegenGenericDataRelationshipType relatedModelName(@javax.annotation.Nonnull String relatedModelName) {
  ...
  public CodegenGenericDataRelationshipType relatedModelFields(@javax.annotation.Nullable List relatedModelFields) {
  ...
  public CodegenGenericDataRelationshipType canUnlinkAssociatedModel(@javax.annotation.Nullable Boolean canUnlinkAssociatedModel) {
  ...
  public CodegenGenericDataRelationshipType relatedJoinFieldName(@javax.annotation.Nullable String relatedJoinFieldName) {
  ...
  public CodegenGenericDataRelationshipType relatedJoinTableName(@javax.annotation.Nullable String relatedJoinTableName) {
  ...
  public CodegenGenericDataRelationshipType belongsToFieldOnRelatedModel(@javax.annotation.Nullable String belongsToFieldOnRelatedModel) {
  ...
  public CodegenGenericDataRelationshipType associatedFields(@javax.annotation.Nullable List associatedFields) {
  ...
  public CodegenGenericDataRelationshipType isHasManyIndex(@javax.annotation.Nullable Boolean isHasManyIndex) {
