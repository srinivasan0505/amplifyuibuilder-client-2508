...
public class FieldInputConfigFileUploaderConfig {
  ...
  public FieldInputConfigFileUploaderConfig accessLevel(@javax.annotation.Nonnull StorageAccessLevel accessLevel) {
  ...
  public FieldInputConfigFileUploaderConfig acceptedFileTypes(@javax.annotation.Nonnull List acceptedFileTypes) {
  ...
  public FieldInputConfigFileUploaderConfig showThumbnails(@javax.annotation.Nullable Boolean showThumbnails) {
  ...
  public FieldInputConfigFileUploaderConfig isResumable(@javax.annotation.Nullable Boolean isResumable) {
  ...
  public FieldInputConfigFileUploaderConfig maxFileCount(@javax.annotation.Nullable Integer maxFileCount) {
  ...
  public FieldInputConfigFileUploaderConfig maxSize(@javax.annotation.Nullable Integer maxSize) {
