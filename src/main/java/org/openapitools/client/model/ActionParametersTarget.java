...
public class ActionParametersTarget {
  ...
  public ActionParametersTarget value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersTarget bindingProperties(@javax.annotation.Nullable ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersTarget collectionBindingProperties(@javax.annotation.Nullable ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersTarget defaultValue(@javax.annotation.Nullable String defaultValue) {
  ...
  public ActionParametersTarget model(@javax.annotation.Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersTarget bindings(@javax.annotation.Nullable Map bindings) {
  ...
  public ActionParametersTarget event(@javax.annotation.Nullable String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersTarget userAttribute(@javax.annotation.Nullable String userAttribute) {
  ...
  public ActionParametersTarget concat(@javax.annotation.Nullable List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersTarget condition(@javax.annotation.Nullable ComponentPropertyCondition condition) {
  ...
  public ActionParametersTarget configured(@javax.annotation.Nullable Boolean configured) {
  ...
  public ActionParametersTarget type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersTarget importedValue(@javax.annotation.Nullable String importedValue) {
  ...
  public ActionParametersTarget componentName(@javax.annotation.Nullable String componentName) {
  ...
  public ActionParametersTarget property(@javax.annotation.Nullable String property) {
