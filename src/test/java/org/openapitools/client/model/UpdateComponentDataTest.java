...
/**
 * Model tests for UpdateComponentData
 */
public class UpdateComponentDataTest {
    private final UpdateComponentData model = new UpdateComponentData();
