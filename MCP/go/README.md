# AWS Amplify UI Builder MCP Server

This MCP (Model Content Protocol) server provides access to AWS Amplify UI Builder API functionality through HTTP, HTTPS, and STDIO transport modes.
