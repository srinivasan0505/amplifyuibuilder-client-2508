...
func RefreshtokenHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RefreshTokenrequest
		...
		url := fmt.Sprintf("%s/tokens/%s/refresh", cfg.BaseURL, provider)
...
func CreateRefreshtokenTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_tokens_provider_refresh",
		mcp.WithDescription("Refreshes a previously issued access token that might have expired."),
		...
		mcp.WithObject("refreshTokenBody", mcp.Required(), mcp.Description("Input parameter: Describes a refresh token.")),
	)
