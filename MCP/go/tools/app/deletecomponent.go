...
func CreateDeletecomponentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_app_appId_environment_environmentName_components_id",
		mcp.WithDescription("Deletes a component from an Amplify app."),
		...
		mcp.WithString("appId", mcp.Required(), mcp.Description("The unique ID of the Amplify app associated with the component to delete.")),
		...
		mcp.WithString("id", mcp.Required(), mcp.Description("The unique ID of the component to delete.")),
	)
