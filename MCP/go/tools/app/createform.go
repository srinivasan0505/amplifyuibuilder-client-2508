...
func CreateformHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateFormrequest
		...
		var result models.CreateFormResponse
...
func CreateCreateformTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_app_appId_environment_environmentName_forms",
		mcp.WithDescription("Creates a new form for an Amplify app."),
		...
		mcp.WithString("appId", mcp.Required(), mcp.Description("The unique ID of the Amplify app to associate with the form.")),
		...
		mcp.WithObject("formToCreate", mcp.Required(), mcp.Description("Input parameter: Represents all of the information that is required to create a form.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    CreateformHandler(cfg),
	}
}
