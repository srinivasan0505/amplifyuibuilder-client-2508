...
func ListcomponentsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.ListComponentsResponse
...
func CreateListcomponentsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_app_appId_environment_environmentName_components",
		mcp.WithDescription("Retrieves a list of components for a specified Amplify app and backend environment."),
		...
		mcp.WithNumber("maxResults", mcp.Description("The maximum number of components to retrieve.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListcomponentsHandler(cfg),
	}
}
