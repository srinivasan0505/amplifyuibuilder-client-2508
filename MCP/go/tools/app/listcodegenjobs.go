...
func ListcodegenjobsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.ListCodegenJobsResponse
...
func CreateListcodegenjobsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_app_appId_environment_environmentName_codegen-jobs",
		mcp.WithDescription("Retrieves a list of code generation jobs for a specified Amplify app and backend environment."),
		...
		mcp.WithNumber("maxResults", mcp.Description("The maximum number of jobs to retrieve.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListcodegenjobsHandler(cfg),
	}
}
