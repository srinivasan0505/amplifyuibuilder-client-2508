...
func CreatecomponentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateComponentrequest
		...
		url := fmt.Sprintf("%s/app/%s/environment/%s/components%s", cfg.BaseURL, appId, environmentName, queryString)
		...
		var result models.CreateComponentResponse
...
func CreateCreatecomponentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_app_appId_environment_environmentName_components",
		mcp.WithDescription("Creates a new component for an Amplify app."),
		...
		mcp.WithString("appId", mcp.Required(), mcp.Description("The unique ID of the Amplify app to associate with the component.")),
		...
		mcp.WithObject("componentToCreate", mcp.Required(), mcp.Description("Input parameter: Represents all of the information that is required to create a component.")),
	)
