...
func GetmetadataHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/app/%s/environment/%s/metadata", cfg.BaseURL, appId, environmentName)
		...
		var result models.GetMetadataResponse
...
func CreateGetmetadataTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_app_appId_environment_environmentName_metadata",
		mcp.WithDescription("Returns existing metadata for an Amplify app."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetmetadataHandler(cfg),
	}
}
