...
func ListthemesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.ListThemesResponse
...
func CreateListthemesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_app_appId_environment_environmentName_themes",
		mcp.WithDescription("Retrieves a list of themes for a specified Amplify app and backend environment."),
		...
		mcp.WithNumber("maxResults", mcp.Description("The maximum number of theme results to return in the response.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListthemesHandler(cfg),
	}
}
