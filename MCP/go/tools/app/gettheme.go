...
func GetthemeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/app/%s/environment/%s/themes/%s", cfg.BaseURL, appId, environmentName, id)
		...
		var result models.GetThemeResponse
...
func CreateGetthemeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_app_appId_environment_environmentName_themes_id",
		mcp.WithDescription("Returns an existing theme for an Amplify app."),
		...
		mcp.WithString("appId", mcp.Required(), mcp.Description("The unique ID of the Amplify app.")),
