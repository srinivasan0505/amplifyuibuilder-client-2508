...
func UpdatecomponentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateComponentrequest
		...
		url := fmt.Sprintf("%s/app/%s/environment/%s/components/%s%s", cfg.BaseURL, appId, environmentName, id, queryString)
		...
		var result models.UpdateComponentResponse
...
func CreateUpdatecomponentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_app_appId_environment_environmentName_components_id",
		mcp.WithDescription("Updates an existing component."),
		...
		mcp.WithString("id", mcp.Required(), mcp.Description("The unique ID for the component.")),
		mcp.WithString("clientToken", mcp.Description("The unique client token.")),
		mcp.WithObject("updatedComponent", mcp.Required(), mcp.Description("Input parameter: Updates and saves all of the information about a component, based on component ID.")),
	)
